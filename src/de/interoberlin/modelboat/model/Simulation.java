package de.interoberlin.modelboat.model;

import java.util.Observable;
import java.util.Observer;

import android.app.Activity;
import de.interoberlin.modelboat.model.accelerometer.AccelerationEvent;
import de.interoberlin.modelboat.model.accelerometer.Accelerometer;
import de.interoberlin.modelboat.model.http.BroadcastThread;
...
public class Simulation implements Observer
{
	...
	public void start()
	{
		// ModelBoatActivity.uiToast("Simulation started");
	...
	public void stop()
	{
		// ModelBoatActivity.uiToast("Simulation stopped");
