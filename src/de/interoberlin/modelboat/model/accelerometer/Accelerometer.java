package de.interoberlin.modelboat.model.accelerometer;
...
public class Accelerometer extends Observable implements SensorEventListener
{
	...
	{
		accelerometer = ((ModelBoatActivity) activity).getSensorManager().getDefaultSensor(Sensor.TYPE_ACCELEROMETER);
	...
	public void start()
	{
		ModelBoatActivity.uiToast("Accelerometer started");
		Log.info("Accelerometer started");
		((ModelBoatActivity) activity).getSensorManager().registerListener(this, accelerometer, SensorManager.SENSOR_DELAY_UI);
	}

	public void stop()
	{
		ModelBoatActivity.uiToast("Accelerometer stopped");
		Log.info("Accelerometer stopped");
		((ModelBoatActivity) activity).getSensorManager().unregisterListener(this);
	}
	...
	public void onSensorChanged(SensorEvent event)
	{
		...
		switch (((ModelBoatActivity) activity).getDisplay().getRotation())
		{
