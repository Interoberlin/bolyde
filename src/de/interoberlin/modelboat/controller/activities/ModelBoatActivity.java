package de.interoberlin.modelboat.controller.activities;
...
public class ModelBoatActivity extends Activity
{
	...
	public boolean onOptionsItemSelected(MenuItem item)
	{
		switch (item.getItemId())
		{
			...
			case R.id.menu_log:
			{
				Intent i = new Intent(ModelBoatActivity.this, LogActivity.class);
				startActivity(i);
				break;
			}
			case R.id.menu_settings:
			{
				Intent i = new Intent(ModelBoatActivity.this, SettingsActivity.class);
				startActivity(i);
				break;
			}
			case R.id.menu_support:
			{
				Intent i = new Intent(ModelBoatActivity.this, SupportActivity.class);
				startActivity(i);
				break;
			}
